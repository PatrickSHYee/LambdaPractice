...
namespace LambdaPractice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<string> shoeProducts = products.Where(s => s.Contains("Shoes")).ToList();
            ...
            List<string> ballProducts = products.Where(b => b.Contains("ball")).ToList();
            ...
            Console.WriteLine(products.OrderBy(f => f.Length).First());
            ...
            Console.WriteLine(products.OrderBy(x => x.Length).Skip(2).Take(1).First());
            ...
            Console.WriteLine(products.OrderBy(x => x.Length).ToList()[1]);
            ...
            var reversedProducts = products.OrderByDescending(x => x.Length).ToList<string>();
            ...
            Console.WriteLine(LongestName(products));
            Console.WriteLine(ShortestName(products));
            Console.WriteLine(SecondLongestName(products));
            Console.WriteLine(ThirdShortestName(products));
            Console.WriteLine(String.Join(", ", BallProducts(products)));
            Console.WriteLine(String.Join(", ", EndInS(products)));
